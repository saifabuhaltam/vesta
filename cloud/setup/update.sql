...
-- =====================================================================
-- Two throwaway accounts, so the two-user isolation check can run
-- against this live project. Gmail plus-addresses land in your normal
-- inbox. Delete these from Authentication -> Users when you are done.
-- =====================================================================
insert into allowed_emails (email, note) values
